...
export default (app: Application) => {
  ...
  router.post('/public/auth/loginUser', userController.loginUser);
  router.post('/public/auth/loginAdmin', userController.loginAdmin);
  router.post('/public/auth/loginOut', userController.loginOut);
